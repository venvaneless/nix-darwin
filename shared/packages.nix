  ...
  system.sharedPackages = {
    ...
    mediaPackages = {
      ...
      qbittorrent = {
        ...
        cli = {
          # Undecided: installable on both platforms, disabled on both for now.
          enable = false;
          installOn = { darwin = true; linux = true; };
          ...
          paths = {
            ...
            linux = {
              profileRoot = paths.linux.home.qbittorrent.profileRoot;
              config = paths.linux.home.qbittorrent.config;
              configFile = paths.linux.home.qbittorrent.configFile;
              downloads = paths.linux.home.qbittorrent.downloads;
            };
          };
