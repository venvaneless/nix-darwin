    ...
    programs.fish.functions = {
        ...
        body = ''
          ...
          command node -e '
            ...
            function move(source, destination) {
              // A prior normalization step can move a parent directory while
              // this pass still holds one of its old child paths. Treat that
      ...
      obsidian-missing = {
        ...
        body = ''
          ...
          function __obsidian_missing_repository_matches_manifest \
          ...
          function __obsidian_missing_current_repository_url --argument-names repository_url
            set --local repository (
              string replace -r '^(?:https?://)?(?:www\\.)?github\\.com/' "" -- "$repository_url" |
              string replace -r '\\.git/?$' "" |
              string trim --chars=/
            ...
            if test -n "$manifest_repository_url"
              ...
              if test -n "$current_repository_url"; and \
                ...
                if test "$current_repository_url" != "$manifest_repository_url"; and \
                    not __obsidian_missing_save_repository_url \
