# shared/terminal/cli-tuis/eza/themes/yahddyyp-catppuccin.nix
#
# =====================================================================
# EZA: YAHDDYYP CATPPUCCIN THEME
#
# - Declares the Yahddyyp Catppuccin theme entirely in Nix
# - Toggle with home.shared.terminal.cliTuis.eza.themes.yahddyypCatppuccin.enable
...
let
  ...
  cfg = ezaCfg.themes.yahddyypCatppuccin;
in
{
  options.home.shared.terminal.cliTuis.eza.themes.yahddyypCatppuccin.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Use the Yahddyyp Catppuccin theme for eza.";
  };
