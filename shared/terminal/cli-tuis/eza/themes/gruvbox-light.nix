...
# - Toggle with home.shared.terminal.cliTuis.eza.themes.gruvboxLight.enable
...
in
{
  options.home.shared.terminal.cliTuis.eza.themes.gruvboxLight.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
