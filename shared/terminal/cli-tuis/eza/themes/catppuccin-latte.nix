...
# - Toggle with home.shared.terminal.cliTuis.eza.themes.catppuccinLatte.enable
...
in
{
  options.home.shared.terminal.cliTuis.eza.themes.catppuccinLatte.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
