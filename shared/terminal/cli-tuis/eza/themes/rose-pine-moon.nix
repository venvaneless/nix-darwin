...
# - Toggle with home.shared.terminal.cliTuis.eza.themes.rosePineMoon.enable
...
in
{
  options.home.shared.terminal.cliTuis.eza.themes.rosePineMoon.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
