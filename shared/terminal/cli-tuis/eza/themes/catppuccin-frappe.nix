...
# - Toggle with home.shared.terminal.cliTuis.eza.themes.catppuccinFrappe.enable
...
in
{
  options.home.shared.terminal.cliTuis.eza.themes.catppuccinFrappe.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
