...
# - Toggle with home.shared.terminal.cliTuis.eza.themes.catppuccinMacchiato.enable
...
in
{
  options.home.shared.terminal.cliTuis.eza.themes.catppuccinMacchiato.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
