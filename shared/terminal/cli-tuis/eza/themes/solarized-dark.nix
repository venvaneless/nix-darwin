...
# - Toggle with home.shared.terminal.cliTuis.eza.themes.solarizedDark.enable
...
in
{
  options.home.shared.terminal.cliTuis.eza.themes.solarizedDark.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
