...
#
# Embedded Lua source generated into .config/wezterm/themes/otto.lua.
...
let
  ...
  luaConfig = pkgs.writeText "otto.lua" /* lua */ ''
...
in
{
  config = lib.mkIf (cfg.enable && cfg.themes.default == "otto") {
