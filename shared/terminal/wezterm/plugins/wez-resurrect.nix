# shared/terminal/wezterm/plugins/wez-resurrect.nix
#
# Embedded Lua source generated into .config/wezterm/plugins/resurrect.lua.
...
let
  ...
  luaConfig = pkgs.writeText "resurrect.lua" /* lua */ ''
...
in
{
  config = lib.mkIf cfg.enable {
    home.file.".config/wezterm/plugins/resurrect.lua".source = luaConfig;
  };
}
