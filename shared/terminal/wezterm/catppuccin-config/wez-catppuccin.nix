# shared/terminal/wezterm/catppuccin-config/wez-catppuccin.nix
#
# Generates the catppuccin.lua runtime module for WezTerm.

{ pkgs, ... }:

pkgs.writeText "catppuccin.lua" /* lua */ ''
  -- /home/ven/.config/terminal/wezterm/catppuccin.lua
