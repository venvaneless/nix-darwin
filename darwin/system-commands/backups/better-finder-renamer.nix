...
let
  betterRenamerBackup = import ./mk-app-backup.nix {
    inherit lib pkgs;
    appName = "A Better Finder Rename";
    appSlug = "better-finder-renamer";
    commandName = "better-renamer-backup";
    sources = [
      { path = "/Users/ven/Library/Application Support/A Better Finder Rename 12"; destination = "app-support/A Better Finder Rename 12"; }
