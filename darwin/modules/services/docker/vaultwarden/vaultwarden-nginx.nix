...
# =========================================
# - Provides vaultwarden-nginx-setup CLI script.
...
let
  ...
  vhostSetup = pkgs.writeShellScriptBin "vaultwarden-nginx-setup" ''
    #!/usr/bin/env bash
    set -euo pipefail
...
{
  # Expose CLI script
  environment.systemPackages = [ vhostSetup ];

  # Activation: write the vhost file automatically
  system.activationScripts.vaultwarden-nginx-conf.text = lib.mkAfter ''
    "${vhostSetup}/bin/vaultwarden-nginx-setup"
  '';
}
