# options/package-options/iterm/iterm-browser-plugin.nix
#
# =====================================================================
# PACKAGE: ITERM2 BROWSER PLUGIN
#
# Packages iTerm2's optional embedded-browser bundle for the Darwin-only
# iTerm2 plugin settings.
# =====================================================================
