# options/package-options/wezterm/plugins/wez-resurrect.nix
#
...
let
  ...
  luaConfig = pkgs.writeText "resurrect.lua" /* lua */ ''
    -- options/package-options/wezterm/plugins/resurrect.lua
    --
    ...
    -- generated by the WezTerm option module are preserved instead of being
    -- overwritten.

    local wezterm = require("wezterm")

    local resurrect = wezterm.plugin.require(
        ${builtins.toJSON cfg.plugins.resurrect.url}
    )
...
in
{
  options.home.shared.terminal.wezterm.plugins.resurrect.url = lib.mkOption {
    type = lib.types.str;
    description = "Git URL for the resurrect.wezterm plugin.";
  };
