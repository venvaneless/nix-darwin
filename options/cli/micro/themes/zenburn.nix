# options/cli/micro/themes/zenburn.nix
#
# =====================================================================
# MICRO: ZENBURN THEME
#
# - Zenburn theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "zenburn"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.zenburn.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Zenburn theme selected in default.nix.";
  };
