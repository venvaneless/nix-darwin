# options/cli/micro/themes/gotham.nix
#
# =====================================================================
# MICRO: GOTHAM THEME
#
# - Gotham theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "gotham"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.gotham.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Gotham theme selected in default.nix.";
  };
