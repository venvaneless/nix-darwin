# options/cli/micro/themes/twilight.nix
#
# =====================================================================
# MICRO: TWILIGHT THEME
#
# - Twilight theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "twilight"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.twilight.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Twilight theme selected in default.nix.";
  };
