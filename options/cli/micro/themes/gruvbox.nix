# options/cli/micro/themes/gruvbox.nix
#
# =====================================================================
# MICRO: GRUVBOX THEME
#
# - Preserves the current custom Gruvbox Micro theme from micro.zip
# - Selected directly in ../default.nix with selectedTheme = "gruvbox"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.gruvbox.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Gruvbox theme selected in default.nix.";
  };
