# options/cli/micro/themes/gruvbox-tc.nix
#
# =====================================================================
# MICRO: GRUVBOX TC THEME
#
# - Gruvbox TC theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "gruvbox-tc"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.gruvbox-tc.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Gruvbox TC theme selected in default.nix.";
  };
