# options/cli/micro/themes/catppuccin-mocha.nix
#
# =====================================================================
# MICRO: CATPPUCCIN MOCHA THEME
#
# - Official Catppuccin Mocha theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "catppuccin"
# =====================================================================
...
let
  ...
  cfg = microCfg.themes.catppuccin;
in
{
  options.home.shared.cli.micro.themes.catppuccin.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Catppuccin Mocha theme selected in default.nix.";
  };
