# options/cli/micro/themes/dukeubuntu-tc.nix
#
# =====================================================================
# MICRO: DUKEUBUNTU TC THEME
#
# - Dukeubuntu TC theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "dukeubuntu-tc"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.dukeubuntu-tc.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Dukeubuntu TC theme selected in default.nix.";
  };
