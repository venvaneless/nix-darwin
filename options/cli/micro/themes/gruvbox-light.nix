# options/cli/micro/themes/gruvbox-light.nix
#
# =====================================================================
# MICRO: GRUVBOX LIGHT THEME
#
# - Gruvbox-Light theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "gruvbox-light"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.gruvbox-light.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Gruvbox-Light theme selected in default.nix.";
  };
