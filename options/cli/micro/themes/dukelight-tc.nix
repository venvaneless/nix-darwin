# options/cli/micro/themes/dukelight-tc.nix
#
# =====================================================================
# MICRO: DUKELIGHT TC THEME
#
# - Dukelight TC theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "dukelight-tc"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.dukelight-tc.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Dukelight TC theme selected in default.nix.";
  };
