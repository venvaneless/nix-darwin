# options/cli/micro/themes/bubblegum.nix
#
# =====================================================================
# MICRO: BUBBLEGUM THEME
#
# - Official Bubblegum theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "bubblegum"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.bubblegum.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Bubblegum theme selected in default.nix.";
  };
