# options/cli/micro/themes/monokai-dark.nix
#
# =====================================================================
# MICRO: MONOKAI DARK THEME
#
# - Monokai Dark theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "monokai-dark"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.monokai-dark.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Monokai Dark theme selected in default.nix.";
  };
