# options/cli/micro/themes/default-theme.nix
#
# =====================================================================
# MICRO: DEFAULT THEME
#
# - Default theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "default"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.default.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Default theme selected in default.nix.";
  };
