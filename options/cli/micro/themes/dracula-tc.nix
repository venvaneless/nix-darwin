# options/cli/micro/themes/dracula-tc.nix
#
# =====================================================================
# MICRO: DRACULA TC THEME
#
# - Dracula TC theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "dracula-tc"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.dracula-tc.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Dracula TC theme selected in default.nix.";
  };
