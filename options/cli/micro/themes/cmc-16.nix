# options/cli/micro/themes/cmc-16.nix
#
# =====================================================================
# MICRO: CAPTAIN MC-CLELLAN'S PERSONAL THEME
#
# - Official CaptainMcClellan's personal theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "cmc-16"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.cmc-16.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the CaptainMcClellan's personal theme selected in default.nix.";
  };
