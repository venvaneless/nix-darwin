# options/cli/micro/themes/monokai.nix
#
# =====================================================================
# MICRO: MONOKAI THEME
#
# - Monokai theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "monokai"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.monokai.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Monokai theme selected in default.nix.";
  };
