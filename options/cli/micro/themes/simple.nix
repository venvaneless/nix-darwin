# options/cli/micro/themes/simple.nix
#
# =====================================================================
# MICRO: SIMPLE THEME
#
# - Simple theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "simple"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.simple.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Simple theme selected in default.nix.";
  };
