# options/cli/micro/themes/material-tc.nix
#
# =====================================================================
# MICRO: MATERIAL TC THEME
#
# - Material TC theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "material-tc"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.material-tc.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Material TC theme selected in default.nix.";
  };
