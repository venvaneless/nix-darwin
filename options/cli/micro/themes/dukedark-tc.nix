# options/cli/micro/themes/dukedark-tc.nix
#
# =====================================================================
# MICRO: DUKEDARK TC THEME
#
# - Dukedark TC theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "dukedark-tc"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.dukedark-tc.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Dukedark TC theme selected in default.nix.";
  };
