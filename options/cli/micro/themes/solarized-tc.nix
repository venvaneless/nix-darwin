# options/cli/micro/themes/solarized-tc.nix
#
# =====================================================================
# MICRO: SOLARIZED TC THEME
#
# - Solarized TC theme for Micro
# - Selected directly in ../default.nix with selectedTheme = "solarized-tc"
# =====================================================================
...
in
{
  options.home.shared.cli.micro.themes.solarized-tc.enable = lib.mkOption {
    type = lib.types.bool;
    default = false;
    description = "Internal switch for the Solarized TC theme selected in default.nix.";
  };
