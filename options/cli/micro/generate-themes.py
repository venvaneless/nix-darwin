...
DESTINATION_DIR = (
    Path.home()
    / ".config/nix/nix-config/options/cli/micro/themes"
)
...
def build_nix_module(
    ...
    return f'''# options/cli/micro/themes/{module_name}.nix
#
# =====================================================================
# MICRO: {human_name.upper()} THEME
#
# - {human_name} theme for Micro
# - Selected directly in ../default.nix with themes.default = "{theme_name}"
# =====================================================================
