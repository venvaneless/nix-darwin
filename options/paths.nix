...
in
{
  ...
  # ------ DOCUMENTS SERVICES ------ #
  #
  # Locally stored service content that is synchronized as part of the
  # Documents tree. Tartarus is served from this local source rather
  # than directly from iCloud.
